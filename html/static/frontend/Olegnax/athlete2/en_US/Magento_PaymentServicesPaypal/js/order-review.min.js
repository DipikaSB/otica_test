...
this.setPlaceOrderButtonActive(true);this.onRequestComplete();};$.ajax({url:this.updateShippingMethodUrl,type:'post',context:this,beforeSend:this.beforeRequestStart,data:formData,success:responseCallback});}}});});