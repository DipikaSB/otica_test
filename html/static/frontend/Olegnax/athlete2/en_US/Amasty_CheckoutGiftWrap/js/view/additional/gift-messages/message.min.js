...
return prefix+area;},collectData:function(){return{item_id:this.item_id,recipient:this.getObservable('recipient')(),sender:this.getObservable('sender')(),message:this.getObservable('message')()}}});});