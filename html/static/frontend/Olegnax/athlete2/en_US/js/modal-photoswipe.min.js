...
if(!_self._isOpen){_self.open();_self._scrollModal($(event.target).data('index'));}else if(_self._isOpen+_self.options.timeoutOpen<new Date().getTime()){_self.close();}});}},});return $.mage.OXmodalPhotoswipe;});