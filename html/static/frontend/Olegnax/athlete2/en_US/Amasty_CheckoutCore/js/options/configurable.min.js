define(['jquery','Magento_ConfigurableProduct/js/configurable','Magento_Ui/js/modal/modal'],function($){'use strict';$.widget('mage.amcheckoutConfigurable',$.mage.configurable,{options:{selectorProduct:'.product'},_initializeOptions:function(){const element=$(this.options.selectorProductPrice??this.options.priceHolderSelector);if(!element.data('magePriceBox')){element.priceBox();}
