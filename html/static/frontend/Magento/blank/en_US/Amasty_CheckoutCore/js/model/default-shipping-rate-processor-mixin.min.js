define(['mage/utils/wrapper','Magento_Checkout/js/model/shipping-rate-registry','Magento_Checkout/js/model/shipping-service','Amasty_CheckoutCore/js/action/get-address-cache-key'],function(wrapper,rateRegistry,shippingService,getAddressCacheKey){'use strict';return function(target){target.getRates=wrapper.wrapSuper(target.getRates,function(address){var cacheKey,cache;if(address.getType()!=='new-address'&&address.getType()!=='new-customer-address'){return this._super();}
...
return this._super();});return target;};});