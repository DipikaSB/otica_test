...
return filteredAddress;},_cleanupAddressFunction:function(value,key){return!_.isFunction(value)&&key!=='save_in_address_book'&&value&&(!_.isEmpty(value)||_.isNumber(value))&&(!_.isArray(value)||_.compact(value).length>0);}};});