...
window.dispatchEvent(new Event('paypal:reinit-express'));},getVaultUrl:function(){return urlBuilder.build('rest/'+this.storeCode+'/V1/braintree/mine/payment/vault');}});return Component.extend(uiC);});