...
namespace Setblue\Magicslider\Block\Widget;
...
{
    const DEFAULT_CACHE_TAG = 'SETBLUE_MAGICSLIDER';
    const MEDIA_PATH = 'setblue/magicslider';
    ...
    public function getMediaUrl($file)
    {
        ...
        return $this->_urlMedia .'setblue/magicslider'. $file;
    }
