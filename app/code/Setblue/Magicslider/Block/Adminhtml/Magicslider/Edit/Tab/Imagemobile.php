...
class Imagemobile extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function getContentHtml()
    {
        ...
        $gallerys = $this->getLayout()->createBlock(
                '\Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Form\GalleryMobile' 
            );
        ...
        $contents = $this->getLayout()->createBlock(
                ...
                'Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Form\Gallery\ContentMobile'
            );
        ...
        //     );
        $video = $this->getLayout()->createBlock(
                'Setblue\Magicslider\Block\Adminhtml\Magicslider\Edit\NewVideo',
                 'new-video-mobile'
            );
