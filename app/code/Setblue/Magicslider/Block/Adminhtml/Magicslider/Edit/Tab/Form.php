...
namespace Setblue\Magicslider\Block\Adminhtml\Magicslider\Edit\Tab;

use Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Form\Snippet;
use Setblue\Magicslider\Model\Status;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Setblue\Magicslider\Model\Magicslider
     */
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'value' => 0,
                'after_element_html' => '<small>Not use lazyload with Images Visible. This feature require module a Magepow_SpeedOptimizer</small>',
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'options' => ['0' => __('No'), '1' => __('Yes')],
                'value' => 0,
                'after_element_html' => '<small>This feature require module a Magepow_SpeedOptimizer</small>',
            ]
        );
