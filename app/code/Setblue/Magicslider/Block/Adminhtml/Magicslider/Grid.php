...
namespace Setblue\Magicslider\Block\Adminhtml\Magicslider;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Setblue\Magicslider\Model\ResourceModel\Magicslider\CollectionFactory $magicsliderCollectionFactory
     * @param array                                                           $data
     */
    public function __construct(
        ...
        \Setblue\Magicslider\Model\Status $status,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'width' => '10px',
                'filter' => false,
                'renderer' => 'Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Grid\Snippet',
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'filter' => false,
                'renderer' => 'Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Grid\Image',
            ]
        );
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    document.querySelectorAll(".copy-to-clipboard").forEach((button) => {
                        button.addEventListener("click", function(e){
                            e.stopPropagation();
                            var copyInput = button.closest(".setblue-snippet").querySelector(".copy-input");
                            copyInput.type = "text";
                            copyInput.select();
