 ...
 */
namespace Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Form\Gallery;
...
class ContentMobile extends \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery\Content
{
    ...
    public function __construct(
        ...
        \Setblue\Magicslider\Model\Magicslider\Media\Config $mediaConfig,
        array $data = []
    ) {
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getChildBlock('uploader')->setTemplate('Setblue_Magicslider::media/uploader.phtml');
        // $this->addChild(
        //     'uploader', 
        //     'Magento\Backend\Block\Media\Uploader',
        //     [
        //         'template' => 'Setblue_Magicslider::media/uploader.phtml'
        //     ]
        // );
