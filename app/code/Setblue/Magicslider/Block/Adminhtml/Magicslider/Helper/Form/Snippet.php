...
namespace Setblue\Magicslider\Block\Adminhtml\Magicslider\Helper\Form;
...
class Snippet extends AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        $shortcodeWidget = '{{widget type="Setblue\Magicslider\Block\Widget\Slider" identifier="' . $identifier . '" template="magicslider.phtml"}}';
        ...
        $html .= '<span>' . __('Add Widget name "Setblue Magicslider widget" and set Identifier or MagicsliderId for it.') . '</span>';
        $html .= '</li><li>';
