...
define([
    ...
    return Collection.extend({
        defaults: {
            template: 'Setblue_InfoOrderGrid/grid/listing',
        ...
        /**
         * Returns CSS class string for a grid row based on its status.
         *
        ...
        getRowClass: function (row, index) {
            ...
            if (row && row.status) {
                classes += ' status-' + row.status.toLowerCase().replace(/\s+/g, '-');
            }
