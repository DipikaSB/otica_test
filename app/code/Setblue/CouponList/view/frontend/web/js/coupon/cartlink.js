define([
    ...
    return Component.extend({
        defaults: {
            template: 'Setblue_CouponList/coupon/cartlink'
        },
        ...
        applyCouponCode: ko.observable(couponCode()),

        initialize: function() {
            self = this;
            this._super();

            // Subscribe to couponCode changes
            couponCode.subscribe(function(newCouponCode) {
                self.applyCouponCode(newCouponCode); 
            });
