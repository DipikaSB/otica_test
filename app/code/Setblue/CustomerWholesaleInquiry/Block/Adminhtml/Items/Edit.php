 ...
 */
namespace Setblue\CustomerWholesaleInquiry\Block\Adminhtml\Items;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Setblue_CustomerWholesaleInquiry';
    ...
    {
        $item = $this->_coreRegistry->registry('current_Setblue_CustomerWholesaleInquiry_items');
        if ($item->getId()) {
