...
return [
    'modules' => [
        ...
        'Amasty_AcartSubscriptionFunctionality' => 1,
        'Amasty_DatePicker' => 1,
        'Amasty_Geoip' => 1,
        'PayPal_Braintree' => 1,
        ...
        'Meetanshi_ReviewReminderBasic' => 1,
        'Olegnax_Athlete2' => 1,
        'Olegnax_Core' => 1,
        ...
        'SEO_Faq' => 1,
        'SEO_GMC' => 1,
        'SEO_HreflangSitemap' => 1,
        'SEO_Index' => 1,
        'SEO_Schema' => 1,
        'Setblue_AllEmailCcBcc' => 1,
        'Setblue_Cart' => 1,
        'Setblue_ContactUsGrid' => 1,
        'Setblue_Core' => 1,
        'Setblue_CouponList' => 1,
        'Setblue_CustomerReview' => 1,
        'Setblue_CustomerWholesaleInquiry' => 1,
        'Setblue_GST' => 1,
        'Setblue_GoogleReview' => 1,
        'Setblue_InfoOrderGrid' => 1,
        'Setblue_Magicslider' => 1,
        'Setblue_OpenAIFeed' => 1,
        'Setblue_OrderCancelEmail' => 1,
        'Setblue_OrderGrid' => 1,
        'Setblue_OticaSku' => 1,
        'Setblue_PrintOrderPdf' => 1,
        'Setblue_ProductWidget' => 1,
        'Setblue_Productmodule' => 1,
        'Setblue_SeoDescription' => 1,
        'Setblue_ShippingRestriction' => 1,
        'Setblue_Shippingtracker' => 1,
        'Setblue_Warranty' => 1,
        'Softnoesis_MassProductReview' => 1,
