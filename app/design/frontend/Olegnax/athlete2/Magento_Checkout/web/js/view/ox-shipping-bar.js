define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            var priceText = $("#sb-freeshipping-val").text().replace(/[^\d.]/g, "");
            this.freeShippingPrice = parseFloat(priceText) || 0;
        ...
        getOptionsText: function () {
            if (this.freeShippingRemaining() <= 0 || $("#sb-website-code").text() == 'in' || $("#sb-website-code").text() == 'base') {
                this.isSuccess(true);
